...
Le budget nécessaire pour organiser la **Nuit du c0de** au sein d'un établissement peut être quasi nul. Il suffit de quelques ordinteurs connectés à internet (un ou deux ordinateurs par équipe), une ou plusieurs salles et des encadrants. La nourriture et les boissons peuvent être pris en charge par les familles. Mais il est aussi possible, si le budget le permet, de prévoir des pizzas, des gateaux, des "goodies" (autocollants et badges par exemple), des récompences...
...
* Des ressources, tutoriels et des supports, ainsi que des  sujets d'entraînements seront fournis à chaque établissement participant.
...
Les établissements inscrits auront accès à de nombreuses ressources : tutoriels, vidéos, guides, espace de discussions... Des univers de jeu avec grilles d'évaluation seront aussi disponibles. Ils pourront être utiliser soit pour organiser des séances d'entraînement avec les élèves, soit comme sujets de sélection (si le nombre d'élèves souhaitant participer est supérieur à la capacité d'accueil de l'établissement). Soit les deux.
...
Pour faciliter le travail des organisateurs, l'évaluation des jeux se fera via une interface dédiée sur le site web de la Nuit du code (www.nuitducode.net). Chaque équipe enregistrera son jeu directement sur le site au debut ou à la fin de l'événement. Des codes d'accès permettront ensuite aux membres du jury (enseignants et élèves - il est important d'impliquer les élèves dans cette évaluation si le temps le permet) d'évaluer tous les jeux en ligne. Les jeux seront jouables depuis cette interface et une grille d'évaluation sera présentée à côté de chaque jeu.

La **Nuit du c0de** n'est pas une compétition. L'idée est donc de valoriser les meilleurs jeux sans pour autant définir un classement strict. Ainsi, à la fin de l'évaluation des jeux, le système ne fournira un classement avec les jeux arrivés premier, deuxième ou troisième mais des résultats par groupes : les deux meilleurs jeux dans chaque catégorie, puis les deux meilleurs suivants...
...
### Début juin 2023 : sélection "Nuit du c0de 2023"
