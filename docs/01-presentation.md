...
La **Nuit du c0de** est un marathon de programmation Scratch et Python (avec le moteur de jeu Pyxel) organisé par le Lycée Français International de Tokyo. Il s'adresse à tous les établissements scolaires français (cours moyen / collège / lycée) de l'étranger et de France.
