...
def draw():
    ...
    #pyxel.text(10,10,f"SCORE : {score}",15)
...
def update():
    ...
    Appelée automatiquement 30x par seconde par pyxel.
    Fait tourner le jeu :
    - met à jour direction en fonction des interactions du joueur
    - si le compteur de frames est atteint:
        * vérifie si le serpent a mangé et éventuellement calcule une
            nouvelle pomme à placer,
    ...
    #maintenant on agit éventuellement sur le serpent
    #mais moins souvent : seulement tous les XX frames
