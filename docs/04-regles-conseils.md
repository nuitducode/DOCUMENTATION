...
Durant l'épreuve de la Nuit du c0de, vous disposerez de 6 heures pour créer un jeu avec Python / Pyxel. Pour cela, vous pouvez utiliser les ressources (fichier .pyxres) mises à votre disposition ou partir de zéro.
