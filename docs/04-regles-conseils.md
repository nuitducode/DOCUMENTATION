...
* <span style="font-weight:bold;background-color:#e6e905">Il n'est pas autorisé</span> de modifier les images des banques d'images des fichiers <kbd>.pyxres</kbd> fournis (par contre, vous pouvez utilser librement les éditeurs de "tilemaps", de sons et de musiques).
* <span style="font-weight:bold;background-color:#e6e905">Il n'est pas autorisé</span> d'aller chercher des informations ou de l'aide sur internet ou sur votre ordinateur.
