...
Les établissements inscrits recevront juste avant la date qu'ils ont fixée pour la Nuit du c0de, les univers de jeu qui seront proposés aux élèves. Ces sujets sont confidentiels !

La durée de l'épreuve est de 6 heures (ou moins pour les élèves de cycle 3) : chaque établissement devra donc s'assurer à l'avance de la possibilité d'une telle période de travail. Par exemple, le Lycée Français de Tokyo organisera son épreuve le 21 mai de 10h à 18h et les jeux réalisés seront testés et évalués à partir de 18h.
...
### Début juin 2023 : Classement "Monde"
